...
<!--                   </li> -->
                   ...
                   <li class="nav-item active"><a class="nav-link" href="${pageContext.request.contextPath}/thongtin/create">Nhập thông tin order</a></li>
                   <li class="nav-item active"><a class="nav-link" href="${pageContext.request.contextPath}/thongtin/list">Thông tin order</a></li>
              </ul>
          </div>
      </div>
  </nav>

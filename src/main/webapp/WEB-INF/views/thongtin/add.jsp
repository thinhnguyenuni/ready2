...
<div class="row w-100 d-flex justify-content-center">
	<div class="col-sm-12 col-md-6 bg-custom p-3 rounded">
		<div class="col-12 text-uppercase h2 text-center text-success ">Đặt
			Vé</div>
		<div class="p-4">
			<form:form action="${pageContext.request.contextPath}/thongtin/create"
				method="post" modelAttribute="thongtin" id="inputForm">
